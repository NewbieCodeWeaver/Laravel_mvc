<footer>
    <div id="footer-top" class="bg-gradient-to-b from-gray-700 to-gray-800 text-center p-5 text-white flex flex-col gap-y-8 md:gap-y-0 md:flex-row py-10">
        <div class="md:w-1/3 flex flex-col items-center justify-center gap-3"><img src="{{url('images/logo.png');}}" width="180px" height="180px" alt="clubs manager" class="z-20 relative"><span>Clubs Manager <?php echo date('Y') ?></span></div>
