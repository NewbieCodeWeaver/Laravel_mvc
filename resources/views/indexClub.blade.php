...
@section('content')
  ...
  <div id="body" class="pt-20 pb-20 pl-14 pr-14 bg-slate-200 bg-[url('../resources/imgs/fondo-campo-football.png')] bg-no-repeat bg-cover	">
      ...
      <tbody>
        ...
        <tr class=" bg-teal-50">
          ...
          <td class="text-base text-gray-900 font-light px-10 py-4 whitespace-nowrap text-center pb-5 ">
            ...
            <a href="{{route('club.edit', $club)}}"><i class="fas fa-edit"></i>editar
            </a> | 
