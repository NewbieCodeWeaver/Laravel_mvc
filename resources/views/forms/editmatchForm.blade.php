...
<div class="bg-slate-200">
    ...
    @method('PUT')
      ...
      <button type="submit" class="bg-teal-500 hover:bg-teal-600 pt-3 pb-3 pl-5 pr-5 text-white rounded mr-3">Actualizar partido</button><a href="{{route('partido.index')}}"><input type="button" value="Volver" class="bg-blue-500 hover:bg-blue-600 pt-3 pb-3 pl-5 pr-5 text-white rounded">
    </form>
  </div>