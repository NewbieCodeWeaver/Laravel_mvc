...
<div class="bg-slate-200">
  <form class=" px-8 pt-6 pb-8 mb-4" method="POST">@csrf
    ...
    <div class="mb-4">
      ...
      <input datepicker datepicker-format="dd-mm-yy" class="shadow  border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fecha-partido" type="text" name="fecha" @error('fecha') is-invalid @enderror>
      @error('fecha')
      <div class="alert alert-danger">
        {{ $message }}
      </div>
